...
Multiple Backends, Dynamic Discovery, Rewrite and Chat
https://sukany.cz/blog/2026-03-23-emacs-gptel-setup/

Tous les LLM dans Emacs, avec gptel
https://www.youtube.com/watch?v=bsRnh_brggM

Shorten Org task titles to ≤67 chars
prompts/shorten.txt from https://github.com/jwiegley/dot-emacs

Generate concise action-oriented titles
prompts/title.txt from https://github.com/jwiegley/dot-emacs
...
Tool-level confirmation remains the primary safeguard.

*** Pre-tool policy

The pre-tool hook adds a second policy layer for tools known to modify data.
