...
The post-tool hook only records tool completion without logging arguments or
returned data.
...
Markdown/Org agent definitions, assembles the system prompt, commands to launch
“gptel-agent” and “gptel-plan” sessions.

** Major tool categories

| Category      | Tool                   | Confirmation | Enabled |
|---------------+------------------------+--------------+---------|
...
- =Bash= (gptel-agent-execute-bash) -- Execute a Bash command.
- =Eval= -- Evaluate Elisp EXPRESSION and return result and any printed output.
- =Diagnostics= -- Flymake across project

*************** TODO Add Elisp evaluation tools?  Or is it Eval?  Live or sandbox?
